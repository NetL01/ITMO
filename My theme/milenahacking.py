...
def initialization():
    ini('Инициализация')
    print('Процесс взлома выполнен успешно')
    time.sleep(1)
    cls_shell()
    ...
    time.sleep(0.4)
    cls_shell()
    print('Скачивание выполнено успешно')
    time.sleep(1)
    cls_shell()
    ...
    cls_shell()
    time.sleep(0.5)
    print('Взлом  завершён')
    time.sleep(0.5)
    cls_shell()
    print('Выполнить слив пользователя Сорокина Милена Сергеевна?  ')
    time.sleep(0.5)
    a = input("Yes OR No: ")
    time.sleep(1)
    while True:
...
def main():
    # draw()
    print('Milena hacking neuroweb is active')
    time.sleep(1)
    ...
    time.sleep(0.2)
    conti = input('Запустить процесс взлома Милены? (y/N):_ ')
    if conti == 'n' or conti == 'N':
        conti = 0
    else:
        conti = 1
    cls_shell()
    print('Hacking process started')
    time.sleep(0.3)
    ...
    time.sleep(0.5)
    cls_shell()
    print('Затраченное время: 1.1124 ms')
    cls_shell()
    time.sleep(1)
    # main try!
    try:
